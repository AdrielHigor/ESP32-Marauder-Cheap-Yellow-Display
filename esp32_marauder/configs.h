#pragma once
 ...
 //// BOARD FEATURES
  ...
  #ifdef MARAUDER_V4
    //#define HAS_BATTERY  // No battery IC on ESP32-S3-CAM N16R8 board
    #define HAS_BT
    #define HAS_NEOPIXEL_LED
    //#define HAS_PWR_MGMT
    #define HAS_SCREEN
    ...
    #define HAS_SD
    #define USE_SD
    //#define HAS_GPS  // GPS_TX=1 (TOUCH_CS) and GPS_RX=3 (TFT_SCLK) conflict on this board
    //#define CYD_22CAP
    //#define CYD_24
    //#define CYD_24G
    //#define CYD_24CAP
  ...
  //// DISPLAY DEFINITIONS
      ...
      // 2.2 capacitive
        ...
        // ESP32-S3-CAM N16R8 RE 1.3 — pins from manufacturer schematic
        // Backlight hardwired to 3.3V; -1 makes backlightOn/Off no-ops
        #define TFT_BL -1
  ...
  //// NEOPIXEL STUFF  
      ...
      #define PIN 33
    #elif defined(MARAUDER_V4)
      #define PIN 48  // ESP32-S3-CAM N16R8: WS2812 hardwired to GPIO48
    #else
      #define PIN 4
    #endif
