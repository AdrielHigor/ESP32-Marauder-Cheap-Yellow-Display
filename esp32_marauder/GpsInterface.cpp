...
// PlatformIO fix: Arduino framework already provides Serial2 as UART2 (GPS_SERIAL_INDEX=2)
// HardwareSerial Serial2(GPS_SERIAL_INDEX); — removed to avoid duplicate symbol
