...
//Making tables
// PlatformIO fix: `static` gives each TU its own copy and avoids "multiple definition"
// linker errors. PROGMEM is a no-op on ESP32 so the tables live in .rodata either way.
